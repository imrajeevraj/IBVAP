...
UPLOAD_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../data/videos/uploads"))
...
def upload_video_for_audit(
    ...
    return {"job_id": job_id, "status": "PROCESSING", "message": "Video uploaded and audit started"}
