...
def list_cameras(db: Session = Depends(get_db), _user=Depends(get_current_user)):
...
def get_camera(camera_id: str, db: Session = Depends(get_db), _user=Depends(get_current_user)):
...
def stream_camera(camera_id: str, db: Session = Depends(get_db), _user=Depends(get_current_user)):
...
def get_camera_status(camera_id: str, _user=Depends(get_current_user)):
