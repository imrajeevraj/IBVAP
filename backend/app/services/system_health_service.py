...
class SystemHealthService:
        ...
        try:
            ...
            if gpu_available:
                ...
                try:
                    ...
                    gpu_percent = round(min(100.0, max(5.0, gpu_memory_percent)), 1) if used_mb > 0 else 0.0
    ...
    def is_healthy() -> bool:
        ...
        return (
            health.cpu_percent < SystemHealthService.CPU_WARNING and
            health.memory_percent < SystemHealthService.MEMORY_WARNING and
            health.disk_percent < SystemHealthService.DISK_WARNING
        )
    ...
    def get_status_string(health: SystemHealth | None = None) -> str:
        ...
        if (health.cpu_percent > SystemHealthService.CPU_CRITICAL or
            health.memory_percent > SystemHealthService.MEMORY_CRITICAL or
            health.disk_percent > SystemHealthService.DISK_CRITICAL):
            return "CRITICAL"
        
        # Check for warning conditions
        if (health.cpu_percent > SystemHealthService.CPU_WARNING or
            health.memory_percent > SystemHealthService.MEMORY_WARNING or
            health.disk_percent > SystemHealthService.DISK_WARNING):
            return "DEGRADED"
