...
class FaceEmbedding(Base):
    ...
    watchlist_status = Column(String, default="UNKNOWN") # UNKNOWN, AUTHORIZED, WATCHLIST
...
class PlateEvent(Base):
    ...
    watchlist_status = Column(String, default="CLEAN") # CLEAN, WATCHLIST, NEEDS_VERIFICATION
    data_origin = Column(String, nullable=False, default="LIVE", index=True) # LIVE, DEMO, TEST, IMPORTED
    timestamp = Column(DateTime, default=datetime.utcnow)
...
class WatchlistEntry(Base):
    ...
    value = Column(String, nullable=False, unique=True) # Plate Number or Face Embedding representation/ID
...
class SecurityEvent(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    event_type = Column(String, nullable=False) # ZONE_ENTRY, ZONE_EXIT, VIRTUAL_FENCE_CROSSING
    camera_id = Column(String, ForeignKey("cameras.id"), nullable=False)
