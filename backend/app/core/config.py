...
class Settings(BaseSettings):
    ...
    MODEL_PATH: str = "C:/Users/rajee/runs/detect/border_threat_detection-3/weights/best.pt"
    MODEL_SHA256: str = ""
...
class ConfigManager:
    ...
    def __init__(self):
        ...
        with self._lock:
            ...
            logger.info("Config manager initialized with %d configuration files", len(self.configs))
